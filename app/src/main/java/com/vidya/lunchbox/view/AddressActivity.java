...
public class AddressActivity extends AppCompatActivity implements OnMapReadyCallback,
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        // AIzaSyDzgOLduOOka9-W3yUjFa21meJ8Ar9Uf_o
        // https://maps.googleapis.com/maps/api/place/nearbysearch/json?location=0.0,0.0&radius=10000&type=school&sensor=true&key=AIzaSyATuUiZUkEc_UgHuqsBJa1oqaODI-3mLs0
        ...
        Dexter.withActivity(this)
                ...
                .withListener(new PermissionListener() {
                    ...
                    public void onPermissionGranted(PermissionGrantedResponse response) {
                        ...
                        mapFragment.getMapAsync(AddressActivity.this);
